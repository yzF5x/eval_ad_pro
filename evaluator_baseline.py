...
from utils.visual_tools import get_attention_from_saved_ablation
...
def main(args):
    ...
    eval_variant_tag = "baseline_ablation"
    ...
    files.sort()
    # files = ['/gpfsdata/home/yizhou/yizhou_lustre/LVLM-results/ablation_0508/MVTecAD_seg_0shot/InternVL3_5-8B-HF/output_attentions/grid__test__good__006.png.pt']
    i = 0
    for fpath in files:
        i += 1
        ...
        target_suffix = "_baseline_aggregated.png" if args.return_aggregate else "_baseline_final.png"
        ...
        pred_mask, sc, sample_outlier_tokens_num, sample_all_tokens_num = get_attention_from_saved_ablation(
    ...
    print("Baseline evaluation complete. Results saved to:", out_model_dir)
